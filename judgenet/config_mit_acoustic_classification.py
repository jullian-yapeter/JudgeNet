from judgenet.modules.dataloader import MITInterviewClassificationDataset
...
# Dataloader Configs
CONFIG.dataset_class = MITInterviewClassificationDataset
